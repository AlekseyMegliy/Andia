...
?>
    ...
    <!-- <header class="container">
        <div class="row">
            ...
            <button class="offset-6 header-button">
                <svg>
            ...
            <div class="col-sm-11 offset-sm-1 col-lg-5 col-xl-5 offset-lg-2 offset-xl-3 nav">
                <a href="./index.html" class="current">
                    <img src="ico//home-sm.png">
                    <p>HOME</p>
                </a>
                <a href="#">
                    <img src="ico/portfolio-sm.png">
                    <p>PORTFOLIO</p>
                </a>
                <a href="#">
                    <img src="ico/blog-sm.png">
                    <p>BLOG</p>
                </a>
                <a href="#">
                    <img src="ico/services-sm.png">
                    <p>SERVICES</p>
                </a>
                <a href="#">
                    <img src="ico/about-sm.png">
                    <p>ABOUT</p>
                </a>
                <a href="#">
                    <img src="ico/contact-sm.png">
                    <p>CONTACT</p>
                </a>
            </div>
    ...
    <div class="block-slider">
        <div class="container">
            <div class="row">
                <div class="slider col-sm-12 col-md-9">
                    <div class="big-slider ">
                        <span class="slider-button-left"></span>

                        <img class="col-12 big-img "  src="img/slider/1.jpg">
                        <span class="col-12">
                            <p class="col-11 slider-text slider-this-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime et obcaecati, illo porro ex provident nisi ipsam cupiditate quo! Quam, impedit veniam commodi dolores </p>
                        </span>

                        <img class="col-12 big-img" src="img/slider/2.jpg">
                        <span class="col-12">
                            <p class="col-9 slider-text ">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iste magnam eum suscipit accusantium explicabo illum voluptatibus nisi pariatur deleniti, ipsa  </p>
                        </span>

                        <img class="col-12 big-img" src="img/slider/3.jpg">
                        <span class="col-12">
                            <p class="col-9 slider-text ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod eveniet aspernatur repellendus minus error voluptatum nostrum velit, cupiditate architecto adipisci dolorem </p>
                        </span>

                        <img class="col-12 big-img " src="img/slider/4.jpg">
                        <span class="col-12">
                            <p class="col-9 slider-text  ">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ducimus spernatur repellendus minus error voluptatum nostrum velit, cupiditate architecto </p>
                        </span>

                        <span class="slider-button-right"></span>
                    </div>
                    <div class="col-12 sm-imgs ">
                        <img class="col-3 sm-img slider-this-simg" src="img/slider/1.jpg">
                        <img class="col-3 sm-img" src="img/slider/2.jpg">
                        <img class="col-3 sm-img" src="img/slider/3.jpg">
                        <img class="col-3 sm-img" src="img/slider/4.jpg">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="row col-sm-12 col-md-10">
                <div class="col-sm-12 col-md-3 benefits">
                    <div>
                        <img class="col-sm-1 col-md-4  col-lg-3" src="ico/eye.png">
                ...
                <div class="col-sm-12 col-md-3 benefits">
                    <div>
                        <img class="col-sm-1 col-md-4 col-lg-3" src="ico/layout.png">
                ...
                <div class="col-sm-12 col-md-3 benefits">
                    <div>
                        <img class="col-sm-1 col-md-4 col-lg-3" src="ico/awesome.png">
                        <h4>AWESOME LOGOS</h4>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, eius eum. Praesentium quae cum, non incidunt voluptas et...</p>
                        <a href="#">Read more</a>
                    </div>
                ...
                <div class="col-sm-12 col-md-3 benefits">
                    <div>
                        <img class="col-sm-1 col-md-4 col-lg-3" src="ico/print.png">
        ...
        <div class="row">
            ...
            <div class="row col-sm-12 col-md-10">
                <div class="col-sm-12 col-md-3 latest">
                    <div>
                        <img class="col-12" src="img/slider/1.jpg">
                        <h4>BEAUTIFUL WEBSITES</h4>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, eius eum. </p>
                        <a href="#"><img class="col-10" src="ico/zoom2.png"></a>
                        <a href="#"><img class="col-10" src="ico/link2.png"></a>
                    </div>
                </div>

                <div class="col-sm-12 col-md-3 latest">
                    <div>
                        <img class="col-12" src="img/slider/2.jpg">
                        <h4>RESPONSIVE LAYOUT</h4>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, eius eum. </p>
                        <a href="#"><img class="col-10" src="ico/zoom2.png"></a>
                        <a href="#"><img class="col-10" src="ico/link2.png"></a>
                ...
                <div class="col-sm-12 col-md-3 latest">
                    <div>
                        <img class="col-12" src="img/slider/3.jpg">
                        <h4>AWESOME LOGOS</h4>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, eius eum. </p>
                        <a href="#"><img class="col-10" src="ico/zoom2.png"></a>
                        <a href="#"><img class="col-10" src="ico/link2.png"></a>
                ...
                <div class="col-sm-12 col-md-3 latest">
                    <div>
                        <img class="col-12" src="img/slider/4.jpg">
                        <h4>HIGH RES PRINTS</h4>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, eius eum.</p>
                        <a href="#"><img class="col-10" src="ico/zoom2.png"></a>
                        <a href="#"><img class="col-10" src="ico/link2.png"></a>
    ...
    <div class="container block-testimonials">
        ...
        <div class="row">
            ...
            <div class="testimonial testimonial-one testi-this col-9">
                ...
                <img class="col-sm-2 col-md-1" src="img/testimonials/1.jpg"> 
            ...
            <div class="testimonial testimonial-three col-9">
                ...
                <img class="col-sm-2 col-md-1" src="img/testimonials/2.jfif"> 
            ...
            <div class="testimonial testimonial-four col-9">
                ...
                <img class="col-sm-2 col-md-1" src="img/testimonials/3.png"> 
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-10 row">
                    ...
                    <div class="col-sm-12 col-md-3 footer">
                        <h4>our team</h4>
                        <img class="col-sm-1 col-md-4 col-lg-3" src="img/testimonials/1.jpg">
                        <img class="col-sm-1 col-md-4 col-lg-3" src="img/testimonials/1.jpg">
                        <img class="col-sm-1 col-md-4 col-lg-3" src="img/testimonials/1.jpg">
                        <img class="col-sm-1 col-md-4 col-lg-3" src="img/testimonials/1.jpg">
                        <img class="col-sm-1 col-md-4 col-lg-3" src="img/testimonials/1.jpg">
                    ...
                    <div class="col-sm-12 col-md-3 footer contact">
                        <h4>CONTACT US</h4>
                        <div>
                            <img class="col-md-1" src="ico/gps.png" width="20px">
                            <p class="col-10"> Address: Lorem city, Ipsum street, 123 </p>
                        </div>
                        <div>
                            <img class="col-md-1" src="ico/phone.png" width="20px">
                            <p class="col-10">Phone: 123456789012 </p>
                        </div>
                        <div>
                            <img class="col-md-1" src="ico/about-sm.png">
                            <p class="col-10">Skype: Lorem_ipsum</p>
                        </div>
                        <div>
                            <img class="col-md-1" src="ico/contact-sm.png">
                            <p class="col-10">Email: quas_sunt_culpa.com </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container copyright">
            <div class="row">
                ...
                <span class="col-sm-5 col-md-4 col-lg-3">
                    <a href="#"><img class="col-1" src="img/social-icons/email.png"></a>
                    <a href="#"><img class="col-1" src="img/social-icons/facebook.png"></a>
                    <a href="#"><img class="col-1" src="img/social-icons/skype.png"></a>
                    <a href="#"><img class="col-1" src="img/social-icons/twitter.png"></a>
                </span>
            </div>
        </div>
    </footer>
